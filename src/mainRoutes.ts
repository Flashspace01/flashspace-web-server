...
import affiliateDashboardRoutes from "./flashspaceWeb/affiliateDashboardModule/routes/affiliateDashboard.routes";
...
// /api/affiliate (Affiliate Dashboard APIs)
mainRoutes.use("/affiliate", affiliateDashboardRoutes);

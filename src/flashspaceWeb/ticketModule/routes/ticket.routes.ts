...
import { uploadTicketAttachment } from '../config/multer.config';

const router = Router();

// ============ USER ROUTES ============
router.post('/', AuthMiddleware.authenticate, RoleMiddleware.requireClientRole, uploadTicketAttachment.array('attachments', 5), TicketValidation.validateCreateTicket, createTicket);
...
router.post('/:ticketId/reply', AuthMiddleware.authenticate, RoleMiddleware.requireClientRole, uploadTicketAttachment.array('attachments', 5), TicketValidation.validateReply, replyToTicket);
...
router.post('/admin/:ticketId/reply', AuthMiddleware.authenticate, RoleMiddleware.requireAdmin, uploadTicketAttachment.array('attachments', 5), TicketValidation.validateReply, addAdminReply);
...
router.post('/partner/:ticketId/reply', AuthMiddleware.authenticate, requireSpacePartner, uploadTicketAttachment.array('attachments', 5), addPartnerReply);
router.post('/partner/:ticketId/close', AuthMiddleware.authenticate, requireSpacePartner, partnerCloseTicket);
router.post('/partner/message-client', AuthMiddleware.authenticate, requireSpacePartner, uploadTicketAttachment.array('attachments', 5), partnerMessageClient);
...
router.post('/affiliate/:ticketId/reply', AuthMiddleware.authenticate, uploadTicketAttachment.array('attachments', 5), TicketValidation.validateReply, addAffiliateReply);

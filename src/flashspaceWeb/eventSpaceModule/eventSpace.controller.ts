...
export const updateEventSpace = async (req: Request, res: Response) => {
  try {
    ...
    const userRole = (req as any).user?.role; // Get the role

    const updatedSpace = await EventSpaceService.updateSpace(
      eventSpaceId,
      validation.data.body,
      userId,
      userRole, // Pass it to the service
    );
...
export const getEventSpaceById = async (req: Request, res: Response) => {
  try {
    ...
    const space = await EventSpaceService.getSpaceById(eventSpaceId as string);
...
export const deleteEventSpace = async (req: Request, res: Response) => {
  try {
    ...
    // FIXED: Removed the undefined 'validation.data.body'
    await EventSpaceService.deleteSpace(
